...
parser.add_argument('-ps','--patch_size',type=int,default=80,metavar='',help='size of patches')
parser.add_argument('-pst','--patch_stride',type=int,default=80,metavar='',help='stride of patches')
...
global_dir = args.root_dir  + 'train_results/model_%s_data_%s_loss_%s_mode_%s_perc_loss_type_%s_patchsize_%d_roll_%s'\
    %(args.model_arc, args.data_file, args.loss_type, args.model_mode, args.perceptual_loss, args.patch_size, args.UFLoss_roll) 
